...
public class Celda {
    ...
    private String imprimir(String color, int linea) {
        ...
        if (ficha != null) {
            ...
            if (linea == 1)
                res = "" + color + celdaColor + ficha.getCaracter() + ANSI_WHITE + ficha.getId() + ficha.getCaracter()
                        + color + celdaColor;
            // res = "" + color + celdaColor + ficha.getCaracter() + ficha.getCaracter() +
            // ficha.getCaracter()
